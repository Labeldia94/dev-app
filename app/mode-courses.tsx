...
const styles = StyleSheet.create({
  ...
  headerLeft:    { flex: 1 },
  foyerName:     { fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
  listName:      { fontSize: 18, fontWeight: '900', marginTop: 1 },
  headerRight:   { flexDirection: 'row', alignItems: 'center', gap: 10 },
  progress:      { fontSize: 14, fontWeight: '700', color: '#34C759' },
  quitBtn:       { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  quitText:      { fontSize: 12, fontWeight: '700', color: '#FF3B30' },

  progressTrack: { height: 5, marginHorizontal: 20, borderRadius: 3, marginBottom: 10 },
  progressBar:   { height: '100%', backgroundColor: '#34C759', borderRadius: 3 },

  listContent:   { paddingHorizontal: 20, paddingTop: 4, paddingBottom: 40 },
  empty:         { textAlign: 'center', marginTop: 60, fontSize: 16 },

  itemRow:       { flexDirection: 'row', alignItems: 'center', borderRadius: 16, marginBottom: 14, overflow: 'hidden', minHeight: 76 },
  itemRowDone:   { opacity: 0.4 },
  rayonAccent:   { width: 6, alignSelf: 'stretch' },
  checkbox:      { width: 32, height: 32, borderRadius: 16, borderWidth: 2.5, borderColor: '#C7C7CC', marginHorizontal: 16, justifyContent: 'center', alignItems: 'center' },
  checkboxDone:  { backgroundColor: '#34C759', borderColor: '#34C759' },
  checkMark:     { color: '#fff', fontSize: 16, fontWeight: '900' },
  itemContent:   { flex: 1, paddingVertical: 16, paddingRight: 16 },
  itemText:      { fontSize: 20, fontWeight: '700', textTransform: 'capitalize' },
  itemTextDone:  { textDecorationLine: 'line-through', color: '#8E8E93' },
  itemSub:       { fontSize: 13, marginTop: 5 },
  itemBy:        { fontSize: 12, color: '#34C759', fontWeight: '600', marginTop: 4 },
